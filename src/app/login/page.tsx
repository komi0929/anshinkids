...
export default function LoginPage() {
 ...
 <Image src="/logo.png" alt="あんしんキッズ ロゴ" width={80} height={80} className="w-full h-full object-contain filter drop- brightness-0 invert" />
 </div>
 <h1
 ...
 <div className="p-5 rounded-2xl bg-white border-[1.5px] border-[var(--color-border)]">
 ...
 <div className="w-10 h-10 rounded-full bg-[var(--color-bg)] flex items-center justify-center text-[18px] border-[1.5px] border-[var(--color-border)]">
 {step.icon}
 </div>
 ...
 className="w-full py-4 px-6 rounded-full font-bold text-[16px] text-white flex items-center justify-center gap-3 transition-all hover:opacity-90 active:scale-95 duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
 style={{
 ...
 {/* Safety Points */}
 <div
 className="mt-8 p-5 rounded-2xl fade-in bg-white border-[1.5px] border-[var(--color-border)]"
