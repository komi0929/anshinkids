...
export const metadata: Metadata = {
  ...
  title: {
    template: "%s | あんしんキッズ",
    default: "あんしんキッズ - 食物アレルギーの知恵を、みんなでつくる",
  },
  description:
    "あんしんキッズは、食物アレルギー（卵・乳・小麦等）を持つ子どもの親が実体験を共有し合うコミュニティです。数百人の親の実体験がAIで整理され、外食・給食・負荷試験など日常の悩みに答える知恵袋を提供しています。",
  ...
  openGraph: {
    ...
    description: "卵・乳・小麦アレルギーなど、食物アレルギーを持つ子どもの親が実体験を共有するコミュニティ。数百の実体験をAIが整理した知恵袋を無料で閲覧できます。",
    url: SITE_URL,
    siteName: "あんしんキッズ",
    locale: "ja_JP",
    type: "website",
      ...
      <head>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{ __html: JSON.stringify({
            ...
            "url": SITE_URL,
            "description": "食物アレルギー（卵・乳・小麦等）を持つ子どもの親が実体験を共有し合う日本最大級のコミュニティプラットフォーム。数百人の親御さんの実際の体験談をAIが整理し、外食・給食・保育園・負荷試験・災害時対応など日常のあらゆる悩みに答える知恵袋を無料で提供しています。",
            "foundingDate": "2025",
            "areaServed": {
              "@type": "Country",
              "name": "Japan"
