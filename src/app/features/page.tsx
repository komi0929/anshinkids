...
export default function FeaturesPage() {
 ...
 {/* Header */}
 <div className="sticky top-0 z-40 px-5 py-4 border-b border-[var(--color-border-light)] bg-white/80 backdrop-blur-md ">
 ...
 {/* Intro */}
 <div className="p-6 rounded-2xl bg-white border-[1.5px] border-[var(--color-border)] ">
 ...
 <span key={tag} className="px-3 py-1 bg-[var(--color-surface-soft)] rounded-full text-[11px] font-extrabold text-[var(--color-subtle)] border-[1.5px] border-[var(--color-border)]">
 {tag}
 </span>
 ))}
 </div>
 ...
 <span className={`w-10 h-10 rounded-[18px] flex items-center justify-center font-black text-[14px] text-white ${category.iconBg} border border-white/20`}>
 {index + 1}
 </span>
 <div>
 ...
 <div key={fIndex} className="p-5 rounded-xl bg-white border-[1.5px] border-[var(--color-border)] hover:border-[var(--color-primary)]/40 hover: transition-all group">
 ...
 <span key={tag} className="text-[9.5px] font-black uppercase tracking-wider text-[var(--color-muted)] bg-[var(--color-surface-soft)] px-2 py-0.5 rounded-lg border-[1.5px] border-[var(--color-border)]">
 {tag}
 </span>
 ))}
 </div>
 ...
 <a href="mailto:partner@anshin-kids.app" className="inline-flex items-center justify-center gap-2 bg-white text-[var(--color-text)] px-6 py-3.5 rounded-2xl text-[14px] font-black hover:scale-[1.02] active:scale-95 duration-200 transition-transform">
