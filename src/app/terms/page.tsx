  ...
  return (
    <div className="min-h-[100dvh] px-4 py-12" style={{ backgroundColor: "var(--color-bg)", color: "var(--color-text)" }}>
      <div className="mx-auto max-w-3xl">
        <h1 className="mb-8 text-2xl font-bold break-keep text-balance">利用規約</h1>
        <section className="space-y-8 text-sm leading-relaxed" style={{ color: "var(--color-text-secondary)" }}>
          ...
          <div>
            <h2 className="text-base font-semibold mb-3 break-keep text-balance" style={{ color: "var(--color-text)" }}>第1条（適用）</h2>
          ...
          <div>
            <h2 className="text-base font-semibold mb-3 break-keep text-balance" style={{ color: "var(--color-text)" }}>第2条（利用登録）</h2>
            <ol className="list-decimal pl-5 space-y-2">
          ...
          <div>
            <h2 className="text-base font-semibold mb-3 break-keep text-balance" style={{ color: "var(--color-text)" }}>第3条（ユーザーIDおよびパスワードの管理）</h2>
            <ol className="list-decimal pl-5 space-y-2">
          ...
          <div>
            <h2 className="text-base font-semibold mb-3 break-keep text-balance" style={{ color: "var(--color-text)" }}>第4条（禁止事項）</h2>
          ...
          <div>
            <h2 className="text-base font-semibold mb-3 break-keep text-balance" style={{ color: "var(--color-text)" }}>第5条（本サービスの提供の停止等）</h2>
            <ol className="list-decimal pl-5 space-y-2">
          ...
          <div>
            <h2 className="text-base font-semibold mb-3 break-keep text-balance" style={{ color: "var(--color-text)" }}>第6条（投稿内容に関する権利と取扱い）</h2>
            <ol className="list-decimal pl-5 space-y-2">
          ...
          <div>
            <h2 className="text-base font-semibold mb-3 break-keep text-balance" style={{ color: "var(--color-text)" }}>第7条（AI機能に関する免責）</h2>
            <ol className="list-decimal pl-5 space-y-2">
          ...
          <div>
            <h2 className="text-base font-semibold mb-3 break-keep text-balance" style={{ color: "var(--color-text)" }}>第8条（利用制限および登録抹消）</h2>
            <ol className="list-decimal pl-5 space-y-2">
          ...
          <div>
            <h2 className="text-base font-semibold mb-3 break-keep text-balance" style={{ color: "var(--color-text)" }}>第9条（保証の否認および免責事項）</h2>
            <ol className="list-decimal pl-5 space-y-2">
          ...
          <div>
            <h2 className="text-base font-semibold mb-3 break-keep text-balance" style={{ color: "var(--color-text)" }}>第10条（サービス内容の変更等）</h2>
            <p>当社は、ユーザーへの事前の告知なくして、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。</p>
          </div>

          <div>
            <h2 className="text-base font-semibold mb-3 break-keep text-balance" style={{ color: "var(--color-text)" }}>第11条（利用規約の変更）</h2>
            <ol className="list-decimal pl-5 space-y-2">
          ...
          <div>
            <h2 className="text-base font-semibold mb-3 break-keep text-balance" style={{ color: "var(--color-text)" }}>第12条（個人情報の取扱い）</h2>
            <p>当社は、本サービスの利用によって取得する個人情報については、当社「プライバシーポリシー」に従い適切に取り扱うものとします。</p>
          </div>

          <div>
            <h2 className="text-base font-semibold mb-3 break-keep text-balance" style={{ color: "var(--color-text)" }}>第13条（準拠法・裁判管轄）</h2>
            <ol className="list-decimal pl-5 space-y-2">
