    ...
    <div className="min-h-screen px-4 py-12" style={{ backgroundColor: "var(--color-bg)", color: "var(--color-text)" }}>
      <div className="mx-auto max-w-3xl">
        ...
        <section className="space-y-8 text-sm leading-relaxed" style={{ color: "var(--color-text-secondary)" }}>
          ...
          <div>
            <h2 className="text-base font-semibold mb-3" style={{ color: "var(--color-text)" }}>第1条（個人情報）</h2>
            <p>「個人情報」とは、個人情報保護法にいう「個人情報」を指すものとし、生存する個人に関する情報であって、当該情報に含まれる氏名、生年月日、住所、電話番号、連絡先その他の記述等により特定の個人を識別できる情報及び容貌、指紋、声紋にかかるデータ、及び健康保険証の保険者番号などの当該情報単体から特定の個人を識別できる情報（個人識別情報）を指します。</p>
          </div>

          <div>
            <h2 className="text-base font-semibold mb-3" style={{ color: "var(--color-text)" }}>第2条（個人情報の収集方法）</h2>
          ...
          <div>
            <h2 className="text-base font-semibold mb-3" style={{ color: "var(--color-text)" }}>第3条（個人情報を収集・利用する目的）</h2>
          ...
          <div>
            <h2 className="text-base font-semibold mb-3" style={{ color: "var(--color-text)" }}>第4条（利用目的の変更）</h2>
            <ol className="list-decimal pl-5 space-y-2">
          ...
          <div>
            <h2 className="text-base font-semibold mb-3" style={{ color: "var(--color-text)" }}>第5条（個人情報の第三者提供）</h2>
            <ol className="list-decimal pl-5 space-y-2">
          ...
          <div>
            <h2 className="text-base font-semibold mb-3" style={{ color: "var(--color-text)" }}>第6条（AI処理における個人情報の取扱い）</h2>
            <ol className="list-decimal pl-5 space-y-2">
          ...
          <div>
            <h2 className="text-base font-semibold mb-3" style={{ color: "var(--color-text)" }}>第7条（個人情報の開示）</h2>
            <ol className="list-decimal pl-5 space-y-2">
          ...
          <div>
            <h2 className="text-base font-semibold mb-3" style={{ color: "var(--color-text)" }}>第8条（個人情報の訂正および削除）</h2>
            <ol className="list-decimal pl-5 space-y-2">
          ...
          <div>
            <h2 className="text-base font-semibold mb-3" style={{ color: "var(--color-text)" }}>第9条（個人情報の利用停止等）</h2>
            <ol className="list-decimal pl-5 space-y-2">
          ...
          <div>
            <h2 className="text-base font-semibold mb-3" style={{ color: "var(--color-text)" }}>第10条（プライバシーポリシーの変更）</h2>
            <ol className="list-decimal pl-5 space-y-2">
          ...
          <div>
            <h2 className="text-base font-semibold mb-3" style={{ color: "var(--color-text)" }}>第11条（お問い合わせ窓口）</h2>
