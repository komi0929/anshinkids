...
function OnboardingWelcome({ profile, onNext, onSkipAll }: {
 ...
 <div className="w-16 h-16 rounded-3xl bg-gradient-to-br from-[var(--color-primary)] to-[var(--color-success)] flex items-center justify-center mx-auto mb-4 ">
 ...
 {/* Profile Card */}
 <div className="bg-white rounded-2xl p-6 border-[1.5px] border-[var(--color-border)] mb-5">
 ...
 maxLength={20}
 className="w-full text-[14px] px-4 py-3 rounded-xl border-[1.5px] border-[var(--color-border)] focus:border-[var(--color-primary)] focus:outline-none transition-colors bg-[var(--color-surface-soft)]"
 ...
 className="w-full py-4 rounded-full bg-[var(--color-primary)] text-white text-[15px] font-black flex items-center justify-center gap-2 hover:scale-[1.02] active:scale-95 duration-200 transition-transform mb-3 shadow-glow"
 >
 次へ：お子さまの情報を登録
...
function OnboardingChildSetup({ initialPrefs, onComplete, onSkip }: {
 ...
 <div className="p-4 rounded-2xl bg-gradient-to-r from-[var(--color-primary-bg)] to-[var(--color-surface-soft)] border-[1.5px] border-[var(--color-border)]">
...
function OnboardingComplete() {
 ...
 <div className="w-20 h-20 mx-auto mb-4 rounded-3xl bg-gradient-to-br from-[var(--color-primary)] to-[var(--color-success)] flex items-center justify-center scale-in">
...
export default function MyPageClient({ initialData }: { initialData: any }) {
 ...
 <div className="w-16 h-16 rounded-3xl bg-gradient-to-br from-[var(--color-surface-soft)] to-[var(--color-primary)]/10 flex items-center justify-center mb-2 ">
 ...
 <div className="w-11 h-11 relative shrink-0 rounded-full overflow-hidden border-[1.5px] border-[var(--color-border)]">
 ...
 className="w-10 h-10 rounded-full flex items-center justify-center bg-white border-[1.5px] border-[var(--color-border)] hover: transition-shadow text-[var(--color-subtle)]"
 aria-label="プロフィール編集"
 >
 ...
 {bookmarks.length === 0 ? (
 <div className="bg-white rounded-2xl p-6 text-center border-[1.5px] border-[var(--color-border)]">
 ...
 key={wiki.id}
 href={url}
 className="block p-5 rounded-2xl bg-white hover: transition-all group relative overflow-hidden border-[1.5px] border-[var(--color-border)]"
 >
 ...
 <span className="px-2 py-0.5 rounded-full bg-[var(--color-accent)] text-white text-[9px] font-bold ">NEW</span>
 ...
 className="px-4 mb-5"
 >
 <div className="bg-gradient-to-br from-[var(--color-primary-bg)] to-white rounded-xl p-5 text-center border border-[var(--color-primary)]/10 border-[1.5px] border-[var(--color-border)]">
 ...
 <button onClick={() => setIsEditing(true)} className="inline-flex items-center gap-1.5 px-4 py-2.5 rounded-xl bg-[var(--color-text)] text-white text-[13px] font-bold hover:scale-[1.02] active:scale-95 duration-200 transition-transform">
 お子さま情報を登録する
 </button>
 </div>
 </motion.div>
 ...
 className="w-full flex items-center justify-between p-4 rounded-2xl bg-white border-[1.5px] border-[var(--color-border)] transition-all active:scale-95 duration-200"
 >
 ...
 <div key={child.id || idx} className="bg-[var(--color-surface-soft)] rounded-[16px] p-3.5 border-[1.5px] border-[var(--color-border)]">
 ...
 <span key={tag} className="px-2 py-0.5 bg-white rounded-full text-[11px] font-bold text-[var(--color-text)]">{tag}</span>
 ))}
 ...
 <Link href="/talk" className="flex-1 flex items-center justify-center gap-2 py-4 rounded-full bg-[var(--color-text)] text-white text-[14px] font-black hover:scale-[1.02] active:scale-95 duration-200 transition-transform ">
 <span>💬</span> トークルームへ
 </Link>
 <Link href="/notifications" className="flex-1 flex items-center justify-center gap-2 py-4 rounded-full bg-white text-[var(--color-text)] text-[14px] font-black border-[1.5px] border-[var(--color-border)] hover: transition-all">
 ...
 <div className="bg-white rounded-2xl border-[1.5px] border-[var(--color-border)] overflow-hidden">
 {/* Privacy toggle */}
 ...
 >
 <span className={`absolute left-0.5 top-0.5 w-5 h-5 bg-white rounded-full transition-transform ${
 // eslint-disable-next-line @typescript-eslint/no-explicit-any
 ...
 <div className="w-16 h-16 shrink-0 relative rounded-full overflow-hidden">
 {renderAvatar(editAvatar, editName || profile?.display_name || "👤")}
 {editAvatar && (
 <button onClick={() => setEditAvatar(null)} className="absolute -top-1.5 -right-1.5 w-6 h-6 bg-white rounded-full flex items-center justify-center border text-[var(--color-muted)] hover:text-[var(--color-danger)] z-10 transition-colors">
 ...
 onChange={e => setEditName(e.target.value)}
 maxLength={20}
 className="w-full text-[14px] px-4 py-3 rounded-xl border-[1.5px] border-[var(--color-border)] focus:border-[var(--color-primary)] focus:outline-none transition-colors"
 placeholder="表示名（例：ゆいママ）"
 />
 </div>
