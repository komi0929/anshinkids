...
export default function SimulationPreview() {
 ...
 <div className={`flex items-center gap-3 p-3 rounded-2xl bg-gradient-to-r ${colors.from} ${colors.to} border-[1.5px] border-[var(--color-border)]/50`}>
 ...
 className="w-full flex items-center justify-between p-3 rounded-xl bg-white border-[1.5px] border-[var(--color-border)] hover:border-[var(--color-primary)]/30 transition-colors"
 >
 <div className="flex items-center gap-2">
 ...
 {expandedToc && (
 <div className="mt-1 p-3 rounded-xl bg-white border-[1.5px] border-[var(--color-border)] space-y-1 animate-in slide-in-from-top-2">
 {sections.map((sec, i) => (
 <button
 key={i}
 ...
 return (
 <div key={j} className="p-3.5 rounded-2xl bg-[var(--color-surface-soft)] border-[1.5px] border-[var(--color-border)] hover:border-[var(--color-primary)]/20 transition-colors">
 {/* Title Row */}
 ...
 {item.is_recommended && (
 <span className="text-[9px] font-bold text-white bg-gradient-to-r from-amber-400 to-orange-400 px-2 py-0.5 rounded-full ">
 👑 定番
 </span>
 )}
 <button
 ...
 <span key={`af-${aidx}`} className="px-2 py-0.5 bg-[var(--color-primary-bg)] text-[var(--color-primary-dark)] rounded-full text-[10px] font-bold border-[1.5px] border-[var(--color-border)]">
 🏷️ {a}不使用
 </span>
 ))}
 ...
 <span key={`si-${sidx}`} className="px-2 py-0.5 bg-[var(--color-primary-bg)] text-[var(--color-primary)] rounded-full text-[10px] font-bold border-[1.5px] border-[var(--color-border)]">
 ✅ {s}
 </span>
 ))}
 </div>
