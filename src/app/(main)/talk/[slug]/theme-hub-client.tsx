...
export default function ThemeHubClient({
 ...
 <Link
 href="/talk"
 className="w-10 h-10 rounded-full flex items-center justify-center bg-white border-[1.5px] border-[var(--color-border)] hover: transition-all active:scale-95"
 >
 <ArrowLeft className="w-5 h-5 text-[var(--color-text)]" />
 </Link>
 <div className="flex items-center gap-3 flex-1">
 <div className="w-12 h-12 rounded-full bg-[var(--color-primary-bg)] flex items-center justify-center text-[24px] ">
 {roomInfo?.icon_emoji || "💬"}
 </div>
 <div>
 ...
 <span className="text-sm bg-[var(--color-surface-soft)] px-1.5 py-0.5 rounded border-[1.5px] border-[var(--color-border)]">📸</span>
 ...
 <div key={idx} className="relative w-28 h-28 flex-shrink-0 rounded-2xl overflow-hidden border-[1.5px] border-[var(--color-border)] snap-center">
 ...
 className="w-full pl-10 pr-4 py-4 rounded-full bg-white text-[14px] font-bold text-[var(--color-text)] placeholder:text-[var(--color-muted)] focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]/40 transition-all border-[1.5px] border-[var(--color-border)]"
 />
 </div>
 ...
 className="text-left px-5 py-4 rounded-2xl bg-white border-[1.5px] border-[var(--color-border)] hover: transition-all flex items-center justify-between group w-full"
 >
 ...
 <div className="py-8 px-3 rounded-2xl bg-[var(--color-surface)] border-[1.5px] border-[var(--color-border)] text-center">
 {searchQuery ? (
 ...
 className="p-5 rounded-2xl bg-white border-[1.5px] border-[var(--color-border)] transition-all group relative overflow-hidden"
 >
 ...
 <span className="text-sm bg-[var(--color-surface-soft)] px-2 py-0.5 rounded-lg border-[1.5px] border-[var(--color-border)] font-bold">
 💬
 </span>
 ...
 initial={{ opacity: 0, y: 10 }}
 animate={{ opacity: 1, y: 0 }}
 className="p-5 rounded-2xl bg-white border-[1.5px] border-[var(--color-border)] hover: transition-all group"
 >
 ...
 <div className="flex items-center gap-2 mb-3">
 <span className="text-xl bg-white border-[1.5px] border-[var(--color-border)] px-2 py-1.5 rounded-full">✏️</span>
 ...
 className="w-full p-5 rounded-2xl bg-white border border-transparent border-[1.5px] border-[var(--color-border)] hover: text-[14px] font-extrabold text-[var(--color-subtle)] hover:text-[var(--color-primary-dark)] transition-all flex items-center justify-center gap-2"
 >
 <Plus className="w-5 h-5" />
 自分で話題を作成する
 </button>
 ) : (
 <div className="p-5 rounded-2xl bg-white slide-up">
 ...
 <span className="text-[36px] drop- block mb-1">💡</span>
 ...
 <div className="text-[15px] font-bold text-[var(--color-text)] leading-snug drop- min-h-[1.5em]">
 ...
 className="w-full h-[48px] flex items-center justify-center rounded-full bg-[var(--color-surface)] hover:bg-[var(--color-border-light)] text-[var(--color-text-secondary)] font-bold text-[14px] active:scale-95 duration-200 transition-transform"
 >
 構わず新しく話題をつくる
 </button>
 </div>
