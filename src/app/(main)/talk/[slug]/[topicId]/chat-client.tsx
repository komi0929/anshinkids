...
export default function ChatClient({
 ...
 <div className="relative rounded-2xl bg-white border-[1.5px] border-[var(--color-border)] p-6 text-center">
 ...
 <span className="text-[11px] font-black text-[var(--color-subtle)] bg-white px-4 py-2 rounded-full border-[1.5px] border-[var(--color-border)] opacity-80">
 {dateStr}
 </span>
 </div>
 ) : null;
 ...
 <div
 className="w-8 h-8 mt-1 flex-shrink-0 rounded-full flex items-center justify-center relative overflow-hidden"
 >
 ...
 <div className="px-5 py-3.5 rounded-2xl rounded-br-[6px] bg-[var(--color-primary)] text-white border-[1.5px] border-[var(--color-border)] break-words whitespace-pre-wrap text-[15px] font-medium leading-relaxed max-w-full">
 {msg.image_url && (
 ...
 : "bg-white text-[var(--color-subtle)] border-[1.5px] border-[var(--color-border)] hover:"
 }`}
 >
 ...
 {activeReactionMsg === msg.id && (
 <div className="absolute bottom-full right-0 mb-2 bg-white/90 backdrop-blur-md border border-[var(--color-border)] rounded-full px-2 py-1.5 flex gap-1 z-50 animate-in fade-in zoom-in duration-200">
 ...
 return (
 <span key={a} className="text-[10px] font-bold bg-[var(--color-primary-bg)] text-[var(--color-primary-dark)] px-2 py-0.5 rounded-full flex items-center gap-1 ">
 {emoji}{a}
 </span>
 );
 })}
 ...
 <div className="px-5 py-3.5 rounded-2xl rounded-bl-[6px] bg-white text-[var(--color-text)] border-[1.5px] border-[var(--color-border)] break-words whitespace-pre-wrap text-[15px] font-medium leading-relaxed max-w-full">
 {msg.image_url && (
 <div className="mb-2 -mx-1 -mt-1 rounded-t-[20px] overflow-hidden relative">
 {/* eslint-disable-next-line @next/next/no-img-element */}
 ...
 activeReactionMsg === msg.id 
 ? "bg-[var(--color-primary-dark)] text-white "
 : "bg-[var(--color-bg)] text-[var(--color-subtle)] hover: border-[1.5px] border-[var(--color-border)] hover:bg-white"
 }`}
 title="リアクションを追加"
 >
 <span className="text-[14px] font-black">+</span>
 ...
 {activeReactionMsg === msg.id && (
 <div className="absolute bottom-full left-0 mb-2 bg-white/90 backdrop-blur-md border border-[var(--color-border)] rounded-full px-2 py-1.5 flex gap-1 z-50 animate-in fade-in zoom-in duration-200">
 {AVAILABLE_REACTIONS.map(emoji => (
 <button
 key={emoji}
 onClick={() => handleReactionToggle(msg.id, emoji)}
 ...
 {/* Header */}
 <div className="px-4 py-3 flex items-center justify-between border-b border-[var(--color-border-light)] bg-white/80 backdrop-blur-md sticky top-0 z-40 ">
 <Link
 href={`/talk/${slug}`}
 ...
 className="w-full flex items-center justify-between p-5 rounded-2xl bg-white border-[1.5px] border-[var(--color-border)] transition-all active:scale-95 duration-200"
 >
 ...
 <span className="text-[12px] font-bold bg-[var(--color-primary-bg)] text-[var(--color-primary-dark)] px-3 py-1 rounded-full border-[1.5px] border-[var(--color-border)]">
 ...
 {showSummary && (
 <div className="mt-2 p-5 rounded-2xl bg-white border-[1.5px] border-[var(--color-border)] slide-up">
 ...
 <div className="relative w-24 h-24 rounded-xl overflow-hidden border-[1.5px] border-[var(--color-border)] inline-block">
 ...
 className="flex-shrink-0 w-12 h-12 flex items-center justify-center rounded-full text-[var(--color-subtle)] bg-white border-[1.5px] border-[var(--color-border)] active:scale-95 transition-all outline-none"
 >
 <Camera className="w-[24px] h-[24px]" />
 </button>
 <div className="flex-1 bg-white rounded-2xl border-[1.5px] border-[var(--color-border)] overflow-hidden flex items-end min-h-[48px] px-5 py-3.5">
 <textarea
 ref={textareaRef}
 value={newMessage}
 ...
 : "bg-white text-[var(--color-muted)] border-[1.5px] border-[var(--color-border)] opacity-70"
 }`}
 >
