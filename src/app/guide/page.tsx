...
export default function GuidePage() {
 ...
 {/* How the loop works */}
 <div className="mx-5 mb-6 p-4 rounded-2xl bg-[var(--color-surface)] border-[1.5px] border-[var(--color-border)] ">
 ...
 <div className="mx-5 mb-8 p-5 rounded-2xl bg-[#FBF8F4] border-[1.5px] border-[var(--color-border)] ">
 ...
 <div
 className="w-8 h-8 rounded-full flex items-center justify-center text-white font-extrabold text-[13px] "
 ...
 {/* Screenshot */}
 <div className="rounded-2xl overflow-hidden border-[1.5px] border-[var(--color-border)] mb-3 bg-[var(--color-surface)]">
 <Image
 src={step.image}
 alt={step.alt}
 width={390}
 ...
 {/* Tip */}
 <div className="p-3 rounded-xl bg-[var(--color-surface-soft)] border-[1.5px] border-[var(--color-border)]">
 <p className="text-[11px] text-[var(--color-text-secondary)] leading-relaxed">
 ...
 <div className="p-5 rounded-2xl bg-gradient-to-br from-[var(--color-primary)] to-[var(--color-success)] text-center ">
 ...
 <Link
 href="/talk"
 className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white text-[var(--color-primary)] font-bold text-[14px] hover: transition-all"
 >
 トークルームを見る
